        ...
        if (!isset($retornar["errors"])) {
            ...
            if (!password_verify($senha, $senha_hash)) {
               ...
               Credenciais incorretas, tente novamente
                ...
                A confirmação para a ativação da conta foi enviada para o e-mail $email
                </div class='btn-confirm'>
                <div><button type='button' id='send_confirmation' class='btn btn-sm btn-primary'>Reenviar confirmação para o email $email</div>
              </div>";
            }
        }
