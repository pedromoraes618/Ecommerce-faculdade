...
if (isset($body->data->id)) {
    ...
    if (isset($payment->id)) {
        ...
        if ($consulta) {
            ...
            $email_confirmacao_empresa = ($linha['cl_email_confirmacao']); //email confirmação para a empresa
            $email_confirmacao_cliente = ($linha['cl_email_verificado']); //email confirmação para o cliente
        ...
        if ($status == "approved") {
            ...
            if (empty($usuario_id)) {
                ...
                if (!empty($verificaUser)) { //cliente já tem cadastro
                    ...
                    $dadosConta = "<div>Identificamos que você já possui um cadastro em nossa loja. Faça login utilizando o seu e-mail $verificaUser e senha para acompanhar seu pedido.</div>";
            ...
            if ($email_confirmacao_cliente == 0) { //email de confirmação para o cliente
            ...
            <hr>
                <div>
                    ...
                    <li style='margin-left:0px;'>Nome: $nome </li>
                    <li style='margin-left:0px;'>Email: $email</li>
                    <li style='margin-left:0px;'>Endereço: $endereco - $numero, $bairro, $complemento, $cidade - $estado </li>
                    <li style='margin-left:0px;'>Contato: $telefone </li>
                    <li style='margin-left:0px;'>Frete: $transportadora </li>
                    <li style='margin-left:0px;'>Forma de pagamento: $formapagamento </li>
                    </ul>
                </div>
            </div>";
            ...
            /*email de confirmação da empresa*/
            if ($email_confirmacao_empresa == 0) {
                $attbodyConfirmar = "Novo pedido! $nomeFantasia recebeu um novo pedido.";
                $assuntoConfirmar = "$nomeFantasia, pedido novo na(o) $nomeEcommerce!";
                $htmlConfirmar = "<div style='max-width: 700px;  margin-left: auto; margin-right: auto;'>
            <p style='margin-bottom: 1rem;'>Pedido #$pedido</p>
            <h3>A $nomeFantasia recebeu um novo pedido que requer sua confirmação.</h3>
            <hr>
            <table width='100%'>
            <tr>
                <td>Produto</td>
            ...
            <p>Detalhe do pedido</p>
            <ul style='list-style-type: none; padding-left: 0;'>
                <li  style='margin-left:0px;'><strong>Forma de pagamento: </strong> $formapagamento</li>
                <li  style='margin-left:0px;'><strong>Frete: </strong> $transportadora</li>
                <li  style='margin-left:0px;'><strong>Dados do cliente</strong>
                <ul style='list-style-type: none;  padding-left: 0;'>
                <li  style='margin-left:0px;'>Nome: $nome</li>
                <li  style='margin-left:0px;'>Email: $email</li>
                <li  style='margin-left:0px;'>Contato: $telefone</li>
                ...
                $mailConfirmar = new PHPMailer(true);
                $sendEmailConfirmar = sendEmailConfirm($mailConfirmar, $assuntoConfirmar, $attbodyConfirmar, $htmlConfirmar); //gerenciador 
                if ($sendEmailConfirmar) {
                    update_registro("tb_pedido_loja", 'cl_id', $external_reference, "", "", "cl_email_confirmacao", 1);
                }
            }
