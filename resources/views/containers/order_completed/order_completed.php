                    ...
                    <div>
                        ...
                        ?>
                            ...
                            <div class="card  bg-body-tertiary  border-0 position-relative mb-1 ">
                                <div class="row g-0 position-relative d-flex justify-content-start just align-items-center">
                                    ...
                                    <div class="col-9">
                                        <div class="card-body">
                                            <div class="text-start mb-2">
                                                <p class="product-title card-title mb-2 lh-sm"><?= $descricao . " x " . $quantidade; ?> </p>
                                                <p class="product-subtitle card-subtitle text-muted"><?= $referencia; ?></p>
                                            </div>
                                            <div class="price fw-semibold text-end"><?= $total; ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="border p-3 rounded mb-3">
                    <div>
                        ...
                        <?php } elseif ($status_pagamento == "pending" or $status_pagamento == "in_process") { ?>
                            <h5 class="text-info">Aguardando Pagamento</h5>
