                    ...
                    <div class="container-sm">
                        ...
                        <div class="form-check mb-3">
                            ...
                            <label class="form-check-label" for="aceita_termos">
                                Aceito os termos e condições. <a href="?company&rules=termsconditions" class="text-decoration-none">Veja</a>
                            </label>
                        ...
                        <div class="d-grid mb-2 gap-2">
                            <button type="submit" class="btn btn-sm btn-dark rounded" id="next"><span>Cadastrar</span>
                                <div class="span-loader" style="display: none;">
