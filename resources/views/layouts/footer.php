...
<div class="container-lg mt-5 pt-5">
    <div class="row justify-content-between gy-4">
        <div class="col-12 col-lg-4">
            <div class="d-flex align-items-center mb-3">
                <a href="./"><img src="<?= "$url_init_img/$empresa/img/ecommerce/logo/logo.png?" . time(); ?>" width="90" alt="logo da Brisa"></a>
            </div>
    ...
    <div class="d-flex flex-column flex-sm-row justify-content-between direitos_reservados border-top mt-3">
        <p class="mb-1" style="font-size:0.8em;">© <?= date('Y'); ?> <?= $nome_fantasia; ?>, Inc. Todos os Direitos Resevados</p>
